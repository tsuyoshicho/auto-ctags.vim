...
execute join(['function! vital#_autoctags#System#Job#Vim#import() abort', printf("return map({'is_available': '', 'start': ''}, \"vital#_autoctags#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___

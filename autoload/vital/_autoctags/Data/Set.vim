...
execute join(['function! vital#_autoctags#Data#Set#import() abort', printf("return map({'set': '', 'frozenset': ''}, \"vital#_autoctags#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim
